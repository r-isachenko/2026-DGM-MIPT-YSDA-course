...
\begin{frame}{Recap of Previous Lecture}
    \myfootnote{\href{https://arxiv.org/abs/2510.21890}{Lai C. H. et al. The principles of diffusion models, 2025.} \\
    \href{https://yang-song.github.io/blog/2021/score/}{Song Y. Generative Modeling by Estimating Gradients of the Data Distribution, blog post, 2021}}
	\vspace{-0.3cm}
...
\begin{frame}{Recap of Previous Lecture}
    ...
    \begin{block}{Noise-Conditioned Score Network (NCSN)}
        \begin{itemize}
            ...
            \]
            \vspace{-0.5cm}
            \item Sample using \textbf{annealed} Langevin dynamics (for $t = T, \dots, 1$).
        \end{itemize}
    \end{block}
    \vspace{-0.3cm}
    \begin{figure}
...
%=======
\begin{frame}{Recap of Previous Lecture}
    \myfootnote{\href{https://arxiv.org/abs/1907.05600}{Song Y. et al. Generative Modeling by Estimating Gradients of the Data Distribution, 2019} \\
    \href{https://arxiv.org/abs/2006.09011}{Song Y. et al. Improved Techniques for Training Score-Based Generative Models, 2020}}
...
\begin{frame}{Forward Gaussian Diffusion Process}
	...
	\begin{enumerate}
		...
		\item $\bx_t = \sqrt{1 - \beta_t} \bx_{t-1} + \sqrt{\beta_t} \bepsilon_t$, $\bepsilon_t \sim \cN(0, \bI)$, $t \geq 1$
...
\begin{frame}{Denoising Score Matching}
    ...
    \eqpause
	\vspace{-0.3cm}
	\textbf{Note:} Annealed Langevin dynamics applies to diffusion, too.
\end{frame}
%=======
...
%=======
\begin{frame}{Reverse Gaussian Diffusion Process}
    \myfootnote{Feller W. On the theory of stochastic processes, with particular reference to applications, 1949 \\
...
\begin{frame}{Reverse Gaussian Diffusion Process (Ancestral Sampling)}
	...
	\begin{minipage}{0.5\linewidth}
		\begin{block}{Forward Process}
			\begin{enumerate}
				\item $\bx_0 = \bx \sim \pd(\bx)$
				\item $\bx_t = \sqrt{1 - \beta_t} \bx_{t-1} + \sqrt{\beta_t} \bepsilon_t$
