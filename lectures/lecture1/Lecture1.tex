...
\begin{frame}{Generative vs Discriminative Models}
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{figs/gen_vs_discrim}
    \end{figure}
    \eqpause
    \begin{itemize}
...
\begin{frame}{Course Team}
    \begin{minipage}[t]{0.32\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \node at (0,0) {\includegraphics[width=2.9cm]{figs/roman}};
    ...
    \begin{minipage}[t]{0.32\linewidth}
        ...
        \begin{tikzpicture}
            \clip (0,0) circle (1.3cm);
            \node at (0,0) {\includegraphics[width=2.9cm]{figs/matvey}};
        \end{tikzpicture}\\[0.5em]
        {\footnotesize
    ...
    \begin{minipage}[t]{0.32\linewidth}
        ...
        \begin{tikzpicture}
            \clip (0,0) circle (1.3cm);
            \node at (0,0) {\includegraphics[width=2.9cm]{figs/grigory}};
        \end{tikzpicture}\\[0.5em]
        {\footnotesize
...
\begin{frame}{Nano Banana Pro}
	...
	\begin{figure}
		\includegraphics[width=\linewidth]{figs/nano_banana}
	\end{figure}
\end{frame}
%=======
...
\begin{frame}{Problem Statement}
	We're given a \textbf{finite} number of i.i.d.\ samples $\{\bx_i\}_{i=1}^n \subset \bbR^m$ drawn from an \textbf{unknown} distribution $\pd(\bx)$.
	\eqpause
...
\begin{frame}{Conditional Models}
	...
	\begin{itemize}
		...
		\item $\by$ = English text, $\bx$ = Russian text $\quad\Rightarrow\quad$ sequence-to-sequence model (machine translation)
...
\begin{frame}{Autoregressive Models}
    ...
    \begin{block}{Sampling (Ancestral)}
    	\begin{enumerate}
    		\item Sample $\hat{x}_1 \sim \pt(x_1)$, $\hat{x}_2 \sim \pt(x_2 | \hat{x}_1)$, \ldots, $\hat{x}_m \sim \pt(x_m | \hat{\bx}_{1:m-1})$.
    		\item Return $\hat{\bx} = (\hat{x}_1, \hat{x}_2, \ldots, \hat{x}_m)$.
    	\end{enumerate}
    \end{block}
    \eqpause
    \begin{itemize}
...
\begin{frame}{Summary}
    \begin{itemize}
    	...
    	\vfill
    	\item Modern generative models span several families --- autoregressive models, normalizing flows, VAEs, GANs, diffusion models --- organized in the course taxonomy.
    	\vfill
    	...
    	\vfill
    	\item Autoregressive models decompose the joint distribution as a product of conditionals $\pt(x_j | \bx_{1:j - 1})$; evaluating the density multiplies them all.
    	\vfill
