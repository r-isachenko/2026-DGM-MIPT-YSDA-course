...
%=======
\begin{frame}{Recap of Previous Lecture}
	\myfootnote{\href{https://jmtomczak.github.io/blog/2/2\_ARM.html}{Image credit: https://jmtomczak.github.io/blog/2/2\_ARM.html}\\ \href{https://arxiv.org/abs/1601.06759}{Oord A., Kalchbrenner N., Kavukcuoglu K. Pixel Recurrent Neural Networks, 2016}\\ \href{https://cdn.openai.com/papers/Generative_Pretraining_from_Pixels_V2.pdf}{Chen M. et al. Generative Pretraining from Pixels, 2020}}
	\vspace{-0.2cm}
	\begin{block}{Autoregressive Models: MLP}
		\vspace{-0.3cm}
 		\begin{figure}
		     \centering
	...
	\begin{block}{Autoregressive Models: ImageGPT}
...
\begin{frame}{Jacobian Determinant}
	\myfootnotewithlink{https://jmtomczak.github.io/blog/3/3\_flows.html}{Image credit: https://jmtomczak.github.io/blog/3/3\_flows.html}
...
\begin{frame}{Composition of Normalizing Flows}
	\myfootnotewithlink{https://lilianweng.github.io/lil-log/2018/10/13/flow-based-deep-generative-models.html}{Image credit: https://lilianweng.github.io/lil-log/2018/10/13/flow-based-deep-generative-models.html}
	\vspace{-0.3cm}
	\begin{figure}
...
\begin{frame}{Linear Normalizing Flows}
	...
	\begin{block}{Invertibility}
		\begin{itemize}
			...
			\item Directly parameterizing all invertible matrices in a continuous way is infeasible \\ (there is no surjective function from $\bbR^{m^2}$ to the set of all invertible matrices of size $m \times m$).
		\end{itemize}
	\end{block}
\end{frame}
%=======
...
\begin{frame}{Gaussian Autoregressive Model}
	...
	\vspace{-0.5cm}
	\eqpause
	\begin{block}{Generative Direction}
		\vspace{-0.3cm}
		\[
	...
	\eqpause
	\begin{itemize}
		\item This gives a \textbf{$C^1$-diffeomorphism} from $p(\bz)$ to $\pt(\bx)$ (assume that $\sigma_j \neq 0$).
		    \eqpause
...
\begin{frame}{Latent Variable Models (LVM)}
	...
	\vspace{-0.3cm}
	\begin{itemize}
		\item $p(\bz)$ is the prior distribution over the latent variable.
		\item $\pt(\bx | \bz)$ is the \textbf{decoder} distribution.
...
\begin{frame}{Summary}
	\begin{itemize}
		...
		\vfill
		\item LVMs introduce latent representations for observed data, building a complex $\pt(\bx)$ from much simpler $\pt(\bx | \bz)$ and $p(\bz)$.
	\end{itemize}
\end{frame}
\end{document}