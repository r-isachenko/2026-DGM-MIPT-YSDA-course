...
\begin{frame}{Recap of Previous Lecture}
	...
	\vspace{-0.1cm}
	\begin{figure}
		\includegraphics[width=0.75\linewidth]{figs/flows_how2}
	\end{figure}
	\vspace{-0.5cm}
...
\begin{frame}{Recap of Previous Lecture}
	...
	\begin{block}{Matrix Decompositions}
		\begin{itemize}
			\item \textbf{LU Decomposition:} $\bW = \bP \bL \bU$, where $\bP$ is a permutation matrix, $\bL$ is lower triangular with positive diagonal, and $\bU$ is upper triangular with positive diagonal.
			\item \textbf{QR Decomposition:} $\bW = \bQ \bR$, where $\bQ$ is orthogonal, and $\bR$ is upper triangular with positive diagonal.
		\end{itemize}
	\end{block}
	\vspace{-0.2cm}
