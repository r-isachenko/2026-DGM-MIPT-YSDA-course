...
| 2 | September, 24 | <b>Lecture 2:</b><ul><li>Normalizing Flows (NF)</li><li>NF Examples<ul><li>Linear NF</li><li>Gaussian Autoregressive NF</li><li>Blockwise Flows (RealNVP / TarFlow)</li></ul></li><li>Latent Variable Models (LVM)</li></ul> | [slides](lectures/lecture2/Lecture2.pdf) |
