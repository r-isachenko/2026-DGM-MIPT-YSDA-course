...
<!---
| 3 | October, 1 | <b>Lecture 3:</b><ul><li>Latent Variable Models (LVM) (continued)</li><li>Variational Evidence Lower Bound (ELBO)</li><li>Amortized Inference</li><li>ELBO Gradients, Reparametrization Trick</li></ul> | [slides](lectures/lecture3/Lecture3.pdf) |
...
| 4 | October, 8 | <b>Lecture 4:</b><ul><li>Variational Autoencoder (VAE)</li><li>ELBO Surgery and Optimal VAE Prior</li><li>Discrete VAE Latent Representations</li><li>Vector Quantized VAE (VQ-VAE)</li><li>Likelihood-Free Learning</li></ul> | [slides](lectures/lecture4/Lecture4.pdf) |
...
| 6 | October, 22 | <b>Lecture 6:</b><ul><li>Langevin Dynamics</li><li>Score Matching<ul><li>Denoising Score Matching</li><li>Noise-Conditioned Score Network (NCSN)</li></ul></li></ul> | [slides](seminars/seminar5/) |
|  |  | <b>Seminar 6:</b> Progressive Growing GAN. StyleGAN | [slides](seminars/seminar6/) |
| 7 | October, 29 | <b>Lecture 7:</b><ul><li>Forward Gaussian Diffusion Process</li><li>Reverse Gaussian Diffusion Process</li><li>Gaussian Diffusion Model as VAE</li><li>Diffusion ELBO Derivation</li></ul> | [slides](lectures/lecture7/Lecture7.pdf) |
|  |  | <b>Seminar 7:</b> Noise Conditioned Score Network (NCSN). Heuristic diffusion model. | [slides](seminars/seminar7/) |
| 8 | November, 5 | <b>Lecture 8:</b><ul><li>Diffusion ELBO Derivation (continued)</li><li>Gaussian Diffusion Reparametrization</li><li>Denoising Diffusion Probabilistic Model (DDPM)</li><li>Model Guidance<ul><li>Classifier Guidance</li><li>Classifier-Free Guidance</li></ul></li></ul> | [slides](lectures/lecture8/Lecture8.pdf) |
|  |  | <b>Seminar 8:</b> Guidance. CLIP, GLIDE, DALL-E 2, Imagen. | [slides](seminars/seminar8/) |
| 9 | November, 12 | <b>Lecture 9:</b><ul><li>Continuous-Time Normalizing Flows (CNF)</li><li>Continuity Equation for CNF Log-Likelihood</li><li>SDE Basics</li></ul> | [slides](lectures/lecture9/Lecture9.pdf) |
...
| 10 | November, 19 | <b>Lecture 10:</b><ul><li>Diffusion and Score Matching SDEs (VP-SDE / VE-SDE)</li><li>Probability Flow ODE</li><li>Reverse SDE</li><li>Score-Based Generative Models Through SDEs</li><li>Flow Matching (FM)</li></ul> | [slides](lectures/lecture10/Lecture10.pdf) |
...
| 11 | November, 26 | <b>Lecture 11:</b><ul><li>Conditional Flow Matching (CFM)<ul><li>CFM Objective</li><li>Conditional Probability Paths</li></ul></li><li>One-Sided Conditioning</li></ul> | [slides](lectures/lecture11/Lecture11.pdf) |
...
| 12 | December, 3 | <b>Lecture 12:</b><ul><li>Two-Sided Conditioning</li><li>Link between Flow Matching and Score-Based Models</li><li>Discrete Diffusion Models</li><li>Forward Discrete Process</li><li>Reverse Diffusion Process</li><li>From Token To Sequence</li></ul> | [slides](lectures/lecture12/Lecture12.pdf) |
...
| 13 | December, 10 | <b>Lecture 13:</b><ul><li>Discrete Diffusion<ul><li>Absorbing Diffusion</li><li>Continuous Time Formulation</li></ul></li><li>Course Overview</li></ul> | [slides](lectures/lecture13/Lecture13.pdf) |
|  |  | <b>Seminar 13:</b> – | |
| 14 | December, 17 | <b>Lecture 14:</b><ul><li>Consistency Models</li><li>Distribution Matching Distillation</li></ul> | [slides](lectures/lecture14/Lecture14.pdf) |
