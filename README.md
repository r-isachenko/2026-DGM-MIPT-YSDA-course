...
|---|---|---|---|
| 1 | September, 17 | <b>Lecture 1:</b><ul><li>Introduction and Logistics</li><li>Generative Models Overview</li><li>Generative Modeling Framework<ul><li>Course Tricks</li><li>Problem Statement</li><li>Divergence Minimization Framework</li></ul></li><li>Autoregressive Models (ImageGPT)</li></ul> | [PDF](lectures-slidev/lecture1/Lecture1.pdf) / [handout](lectures-slidev/lecture1/Lecture1-handout.pdf) |
|  | September, 17 | <b>Seminar 1:</b> Introduction. Maximum likelihood estimation. Histograms. Bayes theorem. PixelCNN. VAR. | [Part 1: MLE](seminars/seminar1/seminar1_Part1.ipynb) · [Part 2: PixelCNN](seminars/seminar1/seminar1_Part2_PixelCNN.ipynb) · [Part 3: VAR](seminars/seminar1/seminar1_Part3_VAR.ipynb) <a href="https://colab.research.google.com/github/r-isachenko/2026-DGM-MIPT-YSDA-course/blob/main/seminars/seminar1/seminar1_Part2_PixelCNN.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> |
| 2 | September, 24 | <b>Lecture 2:</b><ul><li>Normalizing Flows (NF)</li><li>NF Examples<ul><li>Linear NF</li><li>Gaussian Autoregressive NF</li><li>Blockwise Flows (RealNVP / TarFlow)</li></ul></li><li>Latent Variable Models (LVM)</li></ul> | [PDF](lectures-slidev/lecture2/Lecture2.pdf) / [handout](lectures-slidev/lecture2/Lecture2-handout.pdf) |
|  | September, 24 | <b>Seminar 2:</b> Planar and Radial Flows. Forward vs Reverse KL. | [overview](seminars/seminar2/seminar2.ipynb) · [Planar Flow](seminars/seminar2/seminar2_planar_flow.ipynb) · [RealNVP](seminars/seminar2/seminar2_real_nvp.ipynb) |
| 3 | October, 1 | <b>Lecture 3:</b><ul><li>Latent Variable Models (LVM) (continued)</li><li>Variational Evidence Lower Bound (ELBO)</li><li>Amortized Inference</li><li>ELBO Gradients, Reparametrization Trick</li><li>Variational Autoencoder (VAE)</li></ul> | [PDF](lectures-slidev/lecture3/Lecture3.pdf) / [handout](lectures-slidev/lecture3/Lecture3-handout.pdf) |
<!---
...
| 4 | October, 8 | <b>Lecture 4:</b><ul><li>ELBO Surgery and Optimal VAE Prior</li><li>Discrete Latent VAEs<ul><li>Discrete VAE Latent Representations</li><li>Vector Quantized VAE (VQ-VAE)</li></ul></li><li>Likelihood-Free Learning</li><li>Generative Adversarial Networks (GAN)</li></ul> | [PDF](lectures-slidev/lecture4/Lecture4.pdf) / [handout](lectures-slidev/lecture4/Lecture4-handout.pdf) |
...
| 5 | October, 15 | <b>Lecture 5:</b><ul><li>Generative Adversarial Networks (GAN)</li><li>Wasserstein Distance</li><li>Wasserstein GAN (WGAN)</li><li>Evaluation of Likelihood-Free Models<ul><li>Frechet Inception Distance (FID)</li><li>Precision-Recall</li><li>CLIP Score</li><li>Human Eval</li></ul></li><li>Langevin Dynamics</li></ul> | [PDF](lectures-slidev/lecture5/Lecture5.pdf) / [handout](lectures-slidev/lecture5/Lecture5-handout.pdf) |
|  |  | <b>Seminar 5:</b> Vanilla GAN in 1D coding. Mode collapse and vanishing gradients. Non-saturating GAN. Wasserstein GAN (WGAN) and WGAN-GP | [slides](seminars/seminar5/) |
| 6 | October, 22 | <b>Lecture 6:</b><ul><li>Score Matching<ul><li>Denoising Score Matching</li><li>Noise-Conditioned Score Network (NCSN)</li></ul></li><li>Forward Gaussian Diffusion Process</li></ul> | [PDF](lectures-slidev/lecture6/Lecture6.pdf) / [handout](lectures-slidev/lecture6/Lecture6-handout.pdf) |
|  |  | <b>Seminar 6:</b> Progressive Growing GAN. StyleGAN | [slides](seminars/seminar6/) |
| 7 | October, 29 | <b>Lecture 7:</b><ul><li>Reverse Gaussian Diffusion Process</li><li>Gaussian Diffusion Model as VAE</li><li>Diffusion ELBO Derivation</li><li>Gaussian Diffusion Reparametrization</li><li>Denoising Diffusion Probabilistic Model (DDPM)</li></ul> | [PDF](lectures-slidev/lecture7/Lecture7.pdf) / [handout](lectures-slidev/lecture7/Lecture7-handout.pdf) |
|  |  | <b>Seminar 7:</b> Noise Conditioned Score Network (NCSN). Heuristic diffusion model. | [slides](seminars/seminar7/) |
| 8 | November, 5 | <b>Lecture 8:</b><ul><li>DDPM as a Score-Based Generative Model</li><li>Model Guidance<ul><li>Classifier Guidance</li><li>Classifier-Free Guidance</li></ul></li></ul> | [PDF](lectures-slidev/lecture8/Lecture8.pdf) / [handout](lectures-slidev/lecture8/Lecture8-handout.pdf) |
|  |  | <b>Seminar 8:</b> Guidance. CLIP, GLIDE, DALL-E 2, Imagen. | [slides](seminars/seminar8/) |
| 9 | November, 12 | <b>Lecture 9:</b><ul><li>Continuous-Time Normalizing Flows (CNF)</li><li>Continuity Equation for CNF Log-Likelihood</li><li>SDE Basics</li></ul> | [PDF](lectures-slidev/lecture9/Lecture9.pdf) / [handout](lectures-slidev/lecture9/Lecture9-handout.pdf) |
...
| 10 | November, 19 | <b>Lecture 10:</b><ul><li>Diffusion and Score Matching SDEs (VP-SDE / VE-SDE)</li><li>Probability Flow ODE</li><li>Reverse SDE</li><li>Score-Based Generative Models Through SDEs</li><li>Flow Matching (FM)</li></ul> | [PDF](lectures-slidev/lecture10/Lecture10.pdf) / [handout](lectures-slidev/lecture10/Lecture10-handout.pdf) |
...
| 11 | November, 26 | <b>Lecture 11:</b><ul><li>Conditional Flow Matching (CFM)<ul><li>CFM Objective</li><li>Conditional Probability Paths</li></ul></li><li>One-Sided Conditioning</li></ul> | [PDF](lectures-slidev/lecture11/Lecture11.pdf) / [handout](lectures-slidev/lecture11/Lecture11-handout.pdf) |
...
| 12 | December, 3 | <b>Lecture 12:</b><ul><li>Two-Sided Conditioning</li><li>Link between Flow Matching and Score-Based Models</li><li>Discrete Diffusion Models</li><li>Forward Discrete Process</li><li>Reverse Diffusion Process</li><li>From Token To Sequence</li></ul> | [PDF](lectures-slidev/lecture12/Lecture12.pdf) / [handout](lectures-slidev/lecture12/Lecture12-handout.pdf) |
...
| 13 | December, 10 | <b>Lecture 13:</b><ul><li>Discrete Diffusion<ul><li>Absorbing Diffusion</li><li>Continuous Time Formulation</li></ul></li><li>Course Overview</li></ul> | [PDF](lectures-slidev/lecture13/Lecture13.pdf) / [handout](lectures-slidev/lecture13/Lecture13-handout.pdf) |
|  |  | <b>Seminar 13:</b> – | |
| 14 | December, 17 | <b>Lecture 14:</b><ul><li>Consistency Models</li><li>Distribution Matching Distillation</li></ul> | [PDF](lectures-slidev/lecture14/Lecture14.pdf) / [handout](lectures-slidev/lecture14/Lecture14-handout.pdf) |
