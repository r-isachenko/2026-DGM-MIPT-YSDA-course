...
| 4 | October, 8 | <b>Lecture 4:</b><ul><li>ELBO Surgery and Optimal VAE Prior</li><li>Discrete VAE Latent Representations</li><li>Vector Quantized VAE (VQ-VAE)</li><li>Likelihood-Free Learning</li></ul> | [PDF](lectures-slidev/lecture4/Lecture4.pdf) / [handout](lectures-slidev/lecture4/Lecture4-handout.pdf) |
...
| 5 | October, 15 | <b>Lecture 5:</b><ul><li>Generative Adversarial Networks (GAN)</li><li>Wasserstein Distance</li><li>Wasserstein GAN (WGAN)</li><li>Evaluation of Likelihood-Free Models<ul><li>Frechet Inception Distance (FID)</li><li>Precision-Recall</li><li>CLIP Score</li><li>Human Eval</li></ul></li></ul> | [PDF](lectures-slidev/lecture5/Lecture5.pdf) / [handout](lectures-slidev/lecture5/Lecture5-handout.pdf) |
...
| 6 | October, 22 | <b>Lecture 6:</b><ul><li>Langevin Dynamics</li><li>Score Matching<ul><li>Denoising Score Matching</li><li>Noise-Conditioned Score Network (NCSN)</li></ul></li></ul> | [PDF](lectures-slidev/lecture6/Lecture6.pdf) / [handout](lectures-slidev/lecture6/Lecture6-handout.pdf) |
|  |  | <b>Seminar 6:</b> Progressive Growing GAN. StyleGAN | [slides](seminars/seminar6/) |
| 7 | October, 29 | <b>Lecture 7:</b><ul><li>Forward Gaussian Diffusion Process</li><li>Reverse Gaussian Diffusion Process</li><li>Gaussian Diffusion Model as VAE</li><li>Diffusion ELBO Derivation</li></ul> | [PDF](lectures-slidev/lecture7/Lecture7.pdf) / [handout](lectures-slidev/lecture7/Lecture7-handout.pdf) |
|  |  | <b>Seminar 7:</b> Noise Conditioned Score Network (NCSN). Heuristic diffusion model. | [slides](seminars/seminar7/) |
| 8 | November, 5 | <b>Lecture 8:</b><ul><li>Diffusion ELBO Derivation (continued)</li><li>Gaussian Diffusion Reparametrization</li><li>Denoising Diffusion Probabilistic Model (DDPM)</li><li>Model Guidance<ul><li>Classifier Guidance</li><li>Classifier-Free Guidance</li></ul></li></ul> | [PDF](lectures-slidev/lecture8/Lecture8.pdf) / [handout](lectures-slidev/lecture8/Lecture8-handout.pdf) |
