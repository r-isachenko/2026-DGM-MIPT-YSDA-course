...
| 3 | October, 1 | <b>Lecture 3:</b><ul><li>Latent Variable Models (LVM) (continued)</li><li>Variational Evidence Lower Bound (ELBO)</li><li>Amortized Inference</li><li>ELBO Gradients, Reparametrization Trick</li><li>Variational Autoencoder (VAE)</li></ul> | [slides](lectures/lecture3/Lecture3.pdf) |
...
| 4 | October, 8 | <b>Lecture 4:</b><ul><li>ELBO Surgery and Optimal VAE Prior</li><li>Discrete VAE Latent Representations</li><li>Vector Quantized VAE (VQ-VAE)</li><li>Likelihood-Free Learning</li></ul> | [slides](lectures/lecture4/Lecture4.pdf) |
...
| 9 | November, 12 | <b>Lecture 9:</b><ul><li>Continuous-Time Normalizing Flows (CNF)</li><li>Continuity Equation for CNF Log-Likelihood</li><li>SDE Basics</li><li>Diffusion and Score Matching SDEs (VP-SDE / VE-SDE)</li></ul> | [slides](lectures/lecture9/Lecture9.pdf) |
...
| 10 | November, 19 | <b>Lecture 10:</b><ul><li>Probability Flow ODE</li><li>Reverse SDE</li><li>Score-Based Generative Models Through SDEs</li><li>Flow Matching (FM)</li></ul> | [slides](lectures/lecture10/Lecture10.pdf) |
...
| 12 | December, 3 | <b>Lecture 12:</b><ul><li>Two-Sided Conditioning</li><li>Link between Flow Matching and Score-Based Models</li><li>Discrete Diffusion Models</li><li>Forward Discrete Process</li></ul> | [slides](lectures/lecture12/Lecture12.pdf) |
...
| 13 | December, 10 | <b>Lecture 13:</b><ul><li>Discrete Diffusion<ul><li>Reverse Diffusion Process</li><li>From Token To Sequence</li><li>Absorbing Diffusion</li><li>Continuous Time Formulation</li></ul></li><li>Course Overview</li></ul> | [slides](lectures/lecture13/Lecture13.pdf) |
|  |  | <b>Seminar 13:</b> – | |
