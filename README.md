...
<!---
| 3 | October, 1 | <b>Lecture 3:</b><ul><li>Latent Variable Models (LVM) (continued)</li><li>Variational Evidence Lower Bound (ELBO)</li><li>Amortized Inference</li><li>ELBO Gradients, Reparametrization Trick</li></ul> | [PDF](lectures-slidev/lecture3/Lecture3.pdf) / [handout](lectures-slidev/lecture3/Lecture3-handout.pdf) |
...
| 4 | October, 8 | <b>Lecture 4:</b><ul><li>Variational Autoencoder (VAE)</li><li>ELBO Surgery and Optimal VAE Prior</li><li>Discrete VAE Latent Representations</li><li>Vector Quantized VAE (VQ-VAE)</li><li>Likelihood-Free Learning</li></ul> | [PDF](lectures-slidev/lecture4/Lecture4.pdf) / [handout](lectures-slidev/lecture4/Lecture4-handout.pdf) |
