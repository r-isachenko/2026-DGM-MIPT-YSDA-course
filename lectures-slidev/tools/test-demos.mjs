...
import { binaryPatterns, conditional, dataset, factors, histogram, isBarsOrStripes, likelihood, sample, seededRandom } from '../lecture1/lib/binary-models.mjs'
import { divergences, forwardFit, logTarget, normal, reverseFit, targetDensity } from '../deferred/kl/lib/kl-demo.mjs'
