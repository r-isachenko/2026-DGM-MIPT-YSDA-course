...
<img class="wide-figure" src="/figs/gen_vs_discrim.png" alt="gen vs discrim" />

<div v-click="1">

- **Discriminative model:** learns a decision boundary $p(\by | \bx)$.
- **Generative model:** learns the data distribution $\pd(\bx)$ (optionally $\pd(\bx, \by)$) and supports **sampling (generation)**.
...
<div class="team">
<div><img src="/figs/roman.jpg" alt="Roman Isachenko" />
...
</div><div><img src="/figs/matvey.jpg" alt="Matvey Morozov" />
...
</div><div><img src="/figs/grigory.jpg" alt="Grigory Ksenofontov" />
...
- **Adversarial:** GAN, WGAN, model quality evaluation.
...
5. GAN; Wasserstein Distance; WGAN; Model Quality Evaluation
...
<TaxonomyDiagram class="taxonomy" alt="Generative models taxonomy: explicit and implicit density, score-based, continuous dynamics, discrete diffusion, and their model families" />
...
<img class="hero" src="/figs/vae.png" alt="vae" />
...
<img class="hero" src="/figs/dcgan.png" alt="dcgan" />
...
<img class="figure-top" src="/figs/gan_evolution.png" alt="gan evolution" />
<img class="figure-bottom" src="/figs/stylegan.png" alt="stylegan" />
...
<img class="hero" src="/figs/LLM-Evolutionary-Tree.png" alt="LLM-Evolutionary-Tree" />
...
# Language Models: 2023–2026

<img class="hero" src="/figs/stanford-llm-progress-2026.png" alt="Stanford AI Index 2026: Arena scores of leading closed and open-weight models from 2023 to early 2026" />

<div class="source"><a href="https://hai.stanford.edu/assets/files/ai_index_report_2026_chapter_2_technical.pdf">Stanford HAI. AI Index Report 2026, Figure 2.1.2, p. 77. Source: Arena historical leaderboard, March 2026.</a><br>Arena scores summarize human preferences in pairwise comparisons.</div>

---
clicks: 0
sourceFrame: "14"
mergedSourceFrames: [15]
class: figure-slide
---

# Diffusion Models — A Breakthrough in Image Generation

**DDPM (2020)** → **Diffusion beats GANs (2021)** → **Midjourney (2022)**

<img class="hero" src="/figs/diffusion_models.png" alt="Image synthesis results from Diffusion Models Beat GANs, 2021" />
<div class="source"><a href="https://arxiv.org/abs/2006.11239">Ho J. et al. Denoising Diffusion Probabilistic Models, 2020</a> · <a href="https://arxiv.org/abs/2105.05233">Dhariwal P., Nichol A. Diffusion Models Beat GANs on Image Synthesis, 2021</a><br><a href="https://www.midjourney.com/explore">Midjourney gallery</a> · <a href="https://docs.midjourney.com/hc/en-us/articles/33329788681101-Legacy-Features">Midjourney model history (2022)</a></div>
...
# Diffusion Language Models — LLaDA (2025)

Language generation can use **iterative unmasking**.

<div class="columns sampling-comparison">
<div>

## Autoregressive

<div class="token-sequence"><span>A</span><span class="empty-token">…</span><span class="empty-token">…</span><span class="empty-token">…</span></div>
<div class="sampling-arrow">↓</div>
<div class="token-sequence"><span>A</span><span>cat</span><span class="empty-token">…</span><span class="empty-token">…</span></div>
<div class="sampling-arrow">↓</div>
<div class="token-sequence"><span>A</span><span>cat</span><span>sleeps</span><span class="empty-token">…</span></div>
<div class="sampling-arrow">↓</div>
<div class="token-sequence"><span>A</span><span>cat</span><span>sleeps</span><span>.</span></div>

Append tokens from left to right.
...
<div class="token-sequence"><span class="masked-token">[M]</span><span class="masked-token">[M]</span><span class="masked-token">[M]</span><span class="masked-token">[M]</span></div>
<div class="sampling-arrow">↓</div>
<div class="token-sequence"><span class="masked-token">[M]</span><span>cat</span><span class="masked-token">[M]</span><span>.</span></div>
<div class="sampling-arrow">↓</div>
<div class="token-sequence"><span>A</span><span>cat</span><span class="masked-token">[M]</span><span>.</span></div>
<div class="sampling-arrow">↓</div>
<div class="token-sequence"><span>A</span><span>cat</span><span>sleeps</span><span>.</span></div>

Restore tokens across the sequence.

</div>
</div>

<div class="source"><a href="https://arxiv.org/abs/2502.09992">Nie S. et al. Large Language Diffusion Models, 2025.</a> · <a href="https://ml-gsai.github.io/LLaDA-demo/">LLaDA project page</a><br>Schematic selected sampling steps; [M] denotes a masked token. Example words stand in for tokens.</div>
...
<img class="hero" src="/figs/sora.png" alt="sora" />
...
<img class="hero" src="/figs/nano_banana.png" alt="nano banana" />
...
# Genie 3 — Interactive World Generation (2025)

<div class="columns balanced">
<img class="column-figure" src="/figs/genie3-worlds.jpg" alt="Official Genie 3 collage: generated environments with directional controls for navigation" />
<div>

- Start from a text prompt.
- Navigate the generated environment.
- Future frames respond to your actions.

</div>
</div>

**World model:** predicts how observations evolve under actions.

<div class="source"><a href="https://deepmind.google/blog/genie-3-a-new-frontier-for-world-models/">Parker-Holder J., Fruchter S. Genie 3: A new frontier for world models. Google DeepMind, August 5, 2025.</a></div>
...
<img class="column-figure" src="/figs/physics_understand.png" alt="physics understand" />
</div>
...
We omit density subscripts: $p(\bx)\equiv p_{\bx}(\bx)$.

<div class="block">

## Log-Derivative Trick (LGT)
...
Let $\bx\sim p(\bx)$, $\by=\bff(\bx)$, and $\bff,\bg$ be measurable with $\bbE\|\bg(\by)\|<\infty$. Then

<div class="math-chain">

$\displaystyle \bbE[\bg(\by)]$
<span v-click="1">$\displaystyle =\bbE_{p(\bx)}\bg(\bff(\bx))=\int p(\bx)\bg(\bff(\bx))d\bx$</span>.
...
<span v-click="3">$\displaystyle =p(\bff(\bx))\left|\det\left(\frac{\partial\bff(\bx)}{\partial\bx}\right)\right|$</span>

</div>
<div v-click="4" class="math-chain">
...
<!-- Click 1: LOTUS identity. Click 2: CoV assumptions and first identity. Click 3: substitute z=f(x). Click 4: inverse CoV identity. Geometry stays fixed. -->
...
Learn a model $p(\bx)\approx\pd(\bx)$ from data (**density estimation**). Two model operations:

<ul>
<li>

**Sampling (generation):** sample a new object $\bx\sim p(\bx)$.

</li>
<li v-click="2">

**Density evaluation:** compute $p(\bx)$ for a given object $\bx$.
...
<TaxonomyDiagram class="taxonomy" autoregressive alt="Generative models taxonomy with Autoregressive models highlighted" />
...
# Sampling vs Density Evaluation
...
<!-- Start in Sampling: inspect the next conditional, click Next pixel, and see the sampled bit join the context. Start over clears the generated prefix for a new draw. Then switch to Density evaluation: the complete observed image is known, and we record the probability of each observed bit. Another image selects a new observed example. The product matches this image's empirical frequency. This is an exact empirical toy model, not a neural-network demo; parameter sharing is explained on the preceding slide. About two minutes. -->
...
</div><div><img class="mlp-figure" src="/figs/sequential_MLP.png" alt="sequential MLP" />
...
<img class="wide-figure" src="/figs/llm_modeling.png" alt="llm modeling" />
...
<img class="pixel-figure" src="/figs/pixelcnn1.png" alt="pixelcnn1" />
</div>
...
<img class="hero" src="/figs/imagegpt.png" alt="imagegpt" />
...
- Density estimation learns a distribution from data; sampling and density evaluation use the fitted model.
- Model families: autoregressive models, normalizing flows, VAEs, GANs, and diffusion models.
